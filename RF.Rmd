...
beh <- read.csv("../CSV/GPS Data/UvA_brood_monitor_hist.csv", header = T)
colour <- read.csv("../CSV/GPS Data/UvA_Transmitter_info.csv", header = T) 
...
nest <- read.csv("../CSV/GPS Data/UvA_nest_locs.csv", header = T)
nest <- nest[,-4]
