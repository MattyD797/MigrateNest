...
setwd("C:/Users/14064/Dropbox/BTGO Movmement Study/MigrateNest/RF tracks/")
files <- list.files("Conservative_seenchicktending")

myfiles <- lapply(paste0("./Conservative_seenchicktending/",files[1:25]), read.csv)
...
xytb_rf <- modelRF(xytb, type = "actual", nob = "-1", ntree = 1201, mtry = 60)
